...
interface DefaultRegistrationProps {
  tournament: Tournament
}

export default function DefaultRegistration({ tournament }: DefaultRegistrationProps) {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Register your team for {tournament.name}. Complete all required fields to submit your registration.
        </CardDescription>
      </CardHeader>
      <CardContent>
