...
import { Plus, Trash2, Users, Phone, Mail, Calendar, MapPin, Trophy, DollarSign, AlertCircle, Crown } from 'lucide-react'
...
interface KnockoutRegistrationProps {
  tournament: Tournament
}

export default function KnockoutRegistration({ tournament }: KnockoutRegistrationProps) {
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          Team Registration - Knockout Tournament
        </CardTitle>
        <CardDescription>
          Register your complete team for this knockout tournament. All {tournament.teamSize} players must be registered at once.
        </CardDescription>
      </CardHeader>
      <CardContent>
