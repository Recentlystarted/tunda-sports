...
export default function Tournaments() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'REGISTRATION_OPEN': return 'bg-green-600 text-white'
      case 'REGISTRATION_CLOSED': return 'bg-yellow-600 text-white'
  ...
  if (isLoading) {
    return (
      <section id="tournaments" className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-background to-muted">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 sm:gap-8 mb-12">
            {tournaments.map((tournament) => (
              <Card key={tournament.id} className="group hover:shadow-xl transition-all duration-300 overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-primary to-primary/90 p-4 sm:p-6 text-primary-foreground">
